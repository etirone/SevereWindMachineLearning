...
sr_df['difference'] = (abs(sr_df['Model 1'] - sr_df['Model 2'])).round(2)
...
for txt in range(len(sr_df.index)):
  allstring = "event_id: {v1}, <br>Time: {v9},  <br><b>Model 1: {v2}%</b>, <br>Model 2: {v5}%, <br>Difference: {v6}%, <br>remarks: {v8}, <br>magnitude: {v10} ".format(
                          v1= str(sr_df['event_id'][txt]),
                          v9 = str(sr_df['Time'][txt]),
                          v2= str(sr_df['Model 1'][txt]), 
                          v5= str(sr_df['Model 2'][txt]),
                          v6= str(sr_df['difference'][txt]),
...
m2_text = []
for txt in range(len(sr_df.index)):
  allstring = "event_id: {v1}, <br>Time: {v9}, <br>Model 1: {v2}%, <br><b>Model 2: {v5}%</b>, <br>Difference: {v6}%, <br>remarks: {v8}, <br>magnitude: {v10}".format(
                          v1= str(sr_df['event_id'][txt]),
                          v9 = str(sr_df['Time'][txt]),
                          v2= str(sr_df['Model 1'][txt]),
                          v5= str(sr_df['Model 2'][txt]), 
...
difference_text = []
for txt in range(len(sr_df.index)):
  allstring = "event_id: {v1}, <br>Time: {v9}, <br>Model 1: {v2}%, <br>Model 2: {v5}%, <br><b>Difference: {v6}%</b>, <br>remarks: {v8}, <br>magnitude: {v10}".format(
                          v1= str(sr_df['event_id'][txt]),
                          v9 = str(sr_df['Time'][txt]),
                          v2= str(sr_df['Model 1'][txt]),
                          v5= str(sr_df['Model 2'][txt]), 
                          ...
                          v8= str(sr_df['remarks_new_line'][txt]),
                          v10 = str(sr_df['magnitude'][txt]))
  difference_text.append(allstring)
...
colors_difference = [['rgb(0,0,0)', 'rgb(0,68,27)'],
                 ['rgb(0,109,44)', 'rgb(35,139,69)'],
                 ['rgb(65,174,118)', 'rgb(102,194,164)'],
                 ['rgb(153,216,201)', 'rgb(204,236,230)'],
                 ['rgb(229,245,249)', 'rgb(247,252,253)']]

colors_difference = [['rgb(247,252,185)', 'rgb(217,240,163)'],
                    ['rgb(204,236,230)', 'rgb(153,216,201)',],
                    ['rgb(102,194,164)', 'rgb(65,174,118)'],
                    ['rgb(35,139,69)', 'rgb(0,109,44)'],
                    ['rgb(0,68,27)', 'rgb(0,0,0)']]

colors_difference = [['rgb(255,255,204)'],
                    ['rgb(194,230,153)'],
                    ['rgb(120,198,121)'],
                    ['rgb(35,132,67)'],
                    ['rgb(0,0,0)']]
...
colorscale_difference = generateDiscreteColourScale(colors_difference)
...
for txt in MG.index:
  allstring = "event_id: {v1}, <br>Time: {v9}, <br>Model 1: {v2}%, <br>Model 2: {v5}%, <br><b>Difference: {v6}%</b>,  <br>remarks: {v8},<br>magnitude: {v10}".format(
                          ...
                          v8= str(MG['remarks_new_line'][txt]),
                          v10=str(MG['magnitude'][txt]))
  difference_mg.append(allstring)
...
values_m1 = sr_df['Model 1']
values_m2 = sr_df['Model 2']
values_difference = sr_df['difference']

m1_MG = MG['Model 1'] 
m2_MG = MG['Model 2']
difference_MG = MG['difference']

m1_EG = EG['Model 1'] 
m2_EG = EG['Model 2']
difference_EG = EG['difference']
...
if 5 not in DN:
  data = [
    ...
    go.Scattermapbox(customdata=sr_df['Model 2'], lon=sr_df['LON'], lat=sr_df['LAT'],
                     ...
                     marker=dict(size=9,cmax=100,cmin=0,color=values_m2,
                     colorbar=dict(title="Probability <br>SR > 50kts (%)<br> "),colorscale=colorscale), mode="markers"),
    go.Scattermapbox(customdata=sr_df['difference'], lon=sr_df['LON'], lat=sr_df['LAT'],
                     hovertext=difference_text, showlegend=False,
                     marker=dict(size=9,cmax=50,cmin=0,color=values_difference,
                     colorbar=dict(title="Difference<br> "),colorscale=colorscale_difference), mode="markers"),
  ...
  # Measured Data Models 1 & 2 
   go.Scattermapbox(customdata=MG['Model 1'], lon=MG['LON'], lat=MG['LAT'],
    ...
    go.Scattermapbox(customdata=MG['difference'], lon=MG['LON'], lat=MG['LAT'],
                     hovertext=difference_mg, showlegend=False,
                     marker=dict(size=9,cmax=50,cmin=0,color=difference_MG,
                     colorbar=dict(title="Difference<br> "),colorscale=colorscale_difference), mode="markers"),
    ...
    go.Scattermapbox(customdata=EG['Model 2'], lon=EG['LON'], lat=EG['LAT'],
                     ...
                     marker=dict(size=9,cmax=100,cmin=0,color=m2_EG,
                     colorbar=dict(title="Probability <br>SR > 50kts (%)<br> "),colorscale=colorscale), mode="markers"),
    go.Scattermapbox(customdata=EG['difference'], lon=EG['LON'], lat=EG['LAT'],
                     hovertext=difference_eg, showlegend=False,
                     marker=dict(size=9,cmax=50,cmin=0,color=difference_EG,
                     colorbar=dict(title="Difference<br> "),colorscale=colorscale_difference), mode="markers") 
          ]
############################## 5% ############################################
...
if 5 not in DN:
  updatemenus=list([
      dict(
          buttons=list([
                  dict(
                  args=['mapbox.style', 'light', {"visible": [True, True, False, False, False, False, False,False, False, False]}],
                  label='Light',
                  method='relayout'
              ),
              dict(
                  args=['mapbox.style', 'satellite-streets', {"visible": [ True, True, False, False, False, False, False, False, False,False]}],
                  label='Satellite with Streets',
                  method='relayout'
              )
          ]),
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, False, False, False, False, False, False, False, False]},{"title": "Model 1 (All SR)"}] 
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, False, True, False, False, False, False, False, False, False]},{"title": "Model 2 (All SR)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, False, False, True, False, False, False, False, False, False]},{"title": "Difference (All SR)"}]
                ),   
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, False, False, False, True, False, False, False, False, False]},{"title": "Model 1 (measured)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, False, False, False, False, True, False, False, False, False]},{"title": "Model 2 (measured)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, False, False, False, False, False, True, False, False, False]},{"title": "Difference (measured)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, False, False, False, False, False, False, True, False, False]},{"title": "Model 1 (estimated)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, False, False, False, False, False, False, False, True, False]},{"title": "Model 2 (estimated)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, False, False, False, False, False, False, False, False, True]},{"title": "Difference (estimated)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
...
if 5 in DN and 15 not in DN:
  updatemenus=list([
      dict(
          buttons=list([
                  dict(
                  args=['mapbox.style', 'light', {"visible": [True, True, True, False, False, False, False, False, False, False, False]}],
                  label='Light',
                  method='relayout'
              ),
              dict(
                  args=['mapbox.style', 'satellite-streets', {"visible": [True, True, True, False, False, False, False, False, False, False, False]}],
                  label='Satellite with Streets',
                  method='relayout'
              )
          ]),
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, True, False, False, False, False, False, False, False, False]},{"title": "Model 1 (All SR)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, False, True, False, False, False, False, False, False, False]},{"title": "Model 2 (All SR)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, False, False, True, False, False, False, False, False, False]},{"title": "Difference (All SR)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, False, False, False, True, False, False, False, False, False]},{"title": "Model 1 (measured)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, False, False, False, False, True, False, False, False, False]},{"title": "Model 2 (measured)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, False, False, False, False, False, True, False, False, False]},{"title": "Difference (measured)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, False, False, False, False, False, False, True, False, False]},{"title": "Model 1 (estimated)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, False, False, False, False, False, False, False, True, False]},{"title": "Model 2 (estimated)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, False, False, False, False, False, False, False, False, True]},{"title": "Difference (estimated)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
...
if 15 in DN and 30 not in DN:
  updatemenus=list([
      dict(
          buttons=list([
                  dict(
                  args=['mapbox.style', 'light', {"visible": [True, True, True, True, False, False, False, False, False, False, False, False]}],
                  label='Light',
                  method='relayout'
              ),
              dict(
                  args=['mapbox.style', 'satellite-streets', {"visible": [True, True, True, True, False, False, False, False, False, False, False, False]}],
                  label='Satellite with Streets',
                  method='relayout'
              )
          ]),
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, True, True, False, False, False, False, False, False, False, False]},{"title": "Model 1 (All SR)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, False, True, False, False, False, False, False, False, False]},{"title": "Model 2 (All SR)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, False, False, True, False, False, False, False, False, False]},{"title": "Difference (All SR)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, True, False, False, False, True, False, False, False, False, False]},{"title": "Model 1 (measured)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, False, False, False, False, True, False, False, False, False]},{"title": "Model 2 (measured)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, False, False, False, False, False, True, False, False, False]},{"title": "Difference (measured)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, True, False, False, False, False, False, False, True, False, False]},{"title": "Model 1 (estimated)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, False, False, False, False, False, False, False, True, False]},{"title": "Model 2 (estimated)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, False, False, False, False, False, False, False, False, True]},{"title": "Difference (estimated)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
...
if 30 in DN and 45 not in DN:
  updatemenus=list([
      dict(
          buttons=list([
                  dict(
                  args=['mapbox.style', 'light', {"visible": [True, True, True, True, True, False, False, False, False, False, False, False, False]}],
                  label='Light',
                  method='relayout'
              ),
              dict(
                  args=['mapbox.style', 'satellite-streets', {"visible": [True, True, True, True, True, False, False, False, False, False, False, False, False]}],
                  label='Satellite with Streets',
                  method='relayout'
              )
          ]),
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, False, False, False, False, False, False, False, False]},{"title": "Model 1 (All SR)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, True, False, True, False, False, False, False, False, False, False]},{"title": "Model 2 (All SR)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, True, False, False, True, False, False, False, False, False, False]},{"title": "Difference (All SR)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, True, True, False, False, False, True, False, False, False, False, False]},{"title": "Model 1 (measured)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, True, False, False, False, False, True, False, False, False, False]},{"title": "Model 2 (measured)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, True, False, False, False, False, False, True, False, False, False]},{"title": "Difference (measured)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, True, True, False, False, False, False, False, False, True, False, False]},{"title": "Model 1 (estimated)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, True, False, False, False, False, False, False, False, True, False]},{"title": "Model 2 (estimated)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, True, False, False, False, False, False, False, False, False, True]},{"title": "Difference (estimated)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
...
if 45 in DN and 60 not in DN:
  updatemenus=list([
      dict(
          buttons=list([
                  dict(
                  args=['mapbox.style', 'light', {"visible": [True, True, True, True, True, True, False, False, False, False, False, False, False, False]}],
                  label='Light',
                  method='relayout'
              ),
              dict(
                  args=['mapbox.style', 'satellite-streets', {"visible": [True, True, True, True, True, True, False, False, False, False, False, False, False, False]}],
                  label='Satellite with Streets',
                  method='relayout'
              )
          ]),
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, True, False, False, False, False, False, False, False, False]},{"title": "Model 1 (All SR)"}]
                ),
                dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, False, True, False, False, False, False, False, False, False]},{"title": "Model 2 (All SR)"}]
                ),
                dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, False, False, True, False, False, False, False, False, False]},{"title": "Difference (All SR)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, False, False, False, True, False, False, False, False, False]},{"title": "Model 1 (measured)"}]
                ),
                  dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, False, False, False, False, True, False, False, False, False]},{"title": "Model 2 (measured)"}]
                ),
                 dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, False, False, False, False, False, True, False, False, False]},{"title": "Difference (measured)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1 ",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, False, False, False, False, False, False, True, False, False]},{"title": "Model 1 (estimated)"}]
                ),
                  dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, False, False, False, False, False, False, False, True, False]},{"title": "Model 2 (estimated)"}]
                ),
                  dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, False, False, False, False, False, False, False, False, True]},{"title": "Difference (estimated)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
...
if 60 in DN:
  updatemenus=list([
      dict(
          buttons=list([
                  dict(
                  args=['mapbox.style', 'light', {"visible": [True, True, True, True, True, True, True, False, False, False, False, False, False, False, False]}],
                  label='Light',
                  method='relayout'
              ),
              dict(
                  args=['mapbox.style', 'satellite-streets', {"visible": [True, True, True, True, True, True, True, False, False, False, False, False, False, False, False]}],
            label='Satellite with Streets',
                  method='relayout'
              )
          ]),
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1 ",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, True, True, False, False, False, False, False, False, False, False]},{"title": "Model 1 (All SR)"}]
                ),
                  dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, True, False, True, False, False, False, False, False, False, False]},{"title": "Model 2 (All SR)"}]
                ),
                 dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, True, False, False, True, False, False, False, False, False, False]},{"title": "Difference (All SR)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, True, False, False, False, True, False, False, False, False, False]},{"title": "Model 1 (measured)"}]
                ),
                  dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, True, False, False, False, False, True, False, False, False, False]},{"title": "Model 2 (measured)"}]
                ),
                  dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, True, False, False, False, False, False, True, False, False, False]},{"title": "Difference (measured)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
      ...
      dict(
          buttons=list([
                  dict(
                    label = "Model 1",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, True, False, False, False, False, False, False, True, False, False]},{"title": "Model 1 (estimated)"}]
                ),
                  dict(
                    label = "Model 2",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, True, False, False, False, False, False, False, False, True, False]},{"title": "Model 2 (estimated)"}]
                ),
                  dict(
                    label = "Difference",
                    method = "update",
                    args = [{"visible": [True, True, True, True, True, True, False, False, False, False, False, False, False, False, True]},{"title": "Difference (estimated)"}]
                ),
              ]),
              direction="down",
              pad={"r": 10, "t": 10},
...
plotly.offline.plot(fig, filename = 'interactive_outlook.html', auto_open=False, image_width=400, image_height=400, include_plotlyjs='cdn')
